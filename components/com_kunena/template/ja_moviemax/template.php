...
/**
* Kunena Component
* @package Kunena.Template.JA_Moviemax
*
...
class KunenaTemplateJA_Moviemax extends KunenaTemplate {
	// Try to find missing files from the following parent templates:
	protected $default = array('ja_moviemax');
	...
	public function initialize() {
		KunenaFactory::loadLanguage('com_kunena.tpl_ja_moviemax');
		...
		$filename = JPATH_SITE . '/components/com_kunena/template/ja_moviemax/css/custom.css';
