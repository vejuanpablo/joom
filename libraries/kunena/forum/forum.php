...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		{
			self::$version = strtoupper ( '4.0.8' );
		}

		self::$version_major = substr(self::$version, 0, 3);
		self::$version_date = ('2016-01-12' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->format('Y-m-d') : '2016-01-12';
		self::$version_name = ('Tokyo' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Tokyo';
	}
}
