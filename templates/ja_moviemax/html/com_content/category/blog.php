...
?>
<div class="blog<?php echo $this->pageclass_sfx;?> <?php if (!$this->params->get('show_page_heading', 1)) : ?>no-pageheader<?php endif; ?>">
	...
	<?php foreach ($this->intro_items as $key => &$item) : ?>
		...
		<?php endif; ?>
			<div class="col-sm-<?php echo round((12 / $this->columns));?> col item">
