...
?>
<ul class="category-module category-module-default <?php echo $moduleclass_sfx; ?>">
	<?php if ($grouped) : ?>
	...
	<?php endif; ?>
  <li class="actions">
    <a class="btn btn-block btn-inverse" href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($jacategory->id));?>"><?php echo JText::_('TPL_VIEW_MORE_INFO'); ?></a>
  </li>
</ul>
