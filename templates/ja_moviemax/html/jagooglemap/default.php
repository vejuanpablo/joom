...
(function(){
	...
	jQuery('#display-misc').addClass('active').css({'visibility': 'hidden', 'height':'0px'}); // show tab with map to load.
	//window.addEvent('domready', function (){
	jQuery(window).load(function(){
		objWidgetMap.displayMap();
		jQuery('#display-misc').removeClass('active').css({'visibility': 'visible', 'height':'auto'}); // hide map tab after we load the library.
	});
})();
</script>
